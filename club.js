...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Modals
  const imageResizeModal = document.getElementById('image-resize-modal');
  const resizeImagePreview = document.getElementById('resize-image-preview');
  ...
  const closeResizeModal = imageResizeModal.querySelector('.close-modal');
  ...
  const closeTableModal = tableModal.querySelector('.close-modal');
  ...
  const templates = {
    'event-report': `
      <div class="event-report-header">
        ...
        <h1>Chitkara University Institute of Engineering & Technology</h1>
      </div>
      
      <table class="event-details-table">
        <tr>
          <th>Title of the Event</th>
          <td contenteditable="true">Shape Your Future: Explore Career Opportunities with Aurus Tech</td>
        </tr>
        <tr>
          <th>Date of the Event</th>
          <td contenteditable="true">10th January 2025</td>
        </tr>
        <tr>
          <th>Venue</th>
          <td contenteditable="true">Pulitzer Hall, Picasso Block, First Floor, Chitkara University, Punjab Campus</td>
        </tr>
        <tr>
          <th>SDG Number</th>
        ...
        <tr>
          ...
          <td contenteditable="true">142</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td contenteditable="true">Shilpa Sasi, Manager - Human Resources</td>
        </tr>
      </table>
      
      <h1>Shape Your Future: Explore Career Opportunities with Aurus Tech</h1>
      
      <div class="event-section">
        <h2>Objectives:</h2>
        <p contenteditable="true">The Pre-Placement Talk and Interviews on "Shape Your Future: Explore Career Opportunities with Aurus Tech," organized by the Department of Computer Science and Engineering at Chitkara University, was held on 10th January 2025 and received a great response from students. The company representative for this event was Ms. Shilpa Sasi, Manager - Human Resources, known for her expertise in talent acquisition and career development.</p>
        <p contenteditable="true">This event provided an overview of Aurus Tech, its services, career opportunities, and the latest industry skills. It also included interaction with the company representative, allowing students to clear their queries regarding placements. The session created awareness among students about the company and its opportunities, helping them make informed career decisions.</p>
        <p contenteditable="true">Throughout the session, the company showcased its vision, mission, values, services, clients, achievements, challenges, and future plans and explained the roles, responsibilities, required skills, career paths, compensation, and work-life balance of employees. The company also encouraged students to ask questions and apply for suitable positions.</p>
      </div>
      
      <div class="event-section">
        <h2>Outcomes:</h2>
        <p contenteditable="true">The outcomes are:</p>
        <ol>
          <li contenteditable="true">The session successfully enhanced participants' knowledge about career opportunities and industry expectations in the engineering sector.</li>
          <li contenteditable="true">Through interactive discussions and presentations, attendees gained deeper insights into the services and opportunities offered by Aurus Tech.</li>
          <li contenteditable="true">Overall, the pre-placement talk and interviews provided a valuable platform for students to enhance their knowledge, clarify doubts, connect with industry experts, and explore potential career paths.</li>
          <li contenteditable="true">The outcomes of the event helped attendees strengthen their skill set and make informed career decisions.</li>
        </ol>
      </div>
        ...
        <div class="event-images">
          <div class="event-image">
            <div class="image-container">
              <img src="https://via.placeholder.com/600x400?text=Add+Event+Image" alt="Students attending the session">
              <div class="image-controls">
                <button class="image-control-btn resize-image-btn"><i class="fas fa-expand"></i></button>
                <button class="image-control-btn remove-image-btn"><i class="fas fa-trash"></i></button>
              </div>
            </div>
            <p class="event-image-caption" contenteditable="true">Students attending the session (10th January 2025)</p>
          </div>
        </div>
      </div>
      
      <div class="event-section">
        <p contenteditable="true">Name & Signature of Coordinator</p>
      </div>
    `,
    'meeting-report': `
      <div class="event-report-header">
      ...
      <table class="event-details-table">
        <tr>
          <th>Meeting Title</th>
          <td contenteditable="true">Department Faculty Meeting</td>
        </tr>
        <tr>
          <th>Date</th>
          <td contenteditable="true">15th January 2025</td>
        </tr>
        <tr>
          <th>Time</th>
          <td contenteditable="true">10:00 AM - 12:00 PM</td>
        </tr>
        <tr>
          <th>Venue</th>
          <td contenteditable="true">Conference Room, CS Department</td>
        </tr>
        <tr>
          <th>Attendees</th>
          <td contenteditable="true">All Faculty Members</td>
        </tr>
        <tr>
          <th>Chaired By</th>
          <td contenteditable="true">Dr. Rajesh Kumar, Head of Department</td>
        </tr>
      </table>
      ...
      <div class="event-section">
        <h2>Agenda:</h2>
        <ol>
          <li contenteditable="true">Review of previous meeting minutes</li>
          <li contenteditable="true">Curriculum updates for upcoming semester</li>
          <li contenteditable="true">Research initiatives and funding opportunities</li>
          <li contenteditable="true">Student performance and feedback</li>
          <li contenteditable="true">Any other business</li>
        </ol>
      </div>
      
      <div class="event-section">
        <h2>Discussion Points:</h2>
        <p contenteditable="true">The meeting began with a welcome address by the HOD, followed by a review of action items from the previous meeting. Key discussion points included:</p>
        <ul>
          <li contenteditable="true">Updates to the curriculum for the upcoming semester were discussed, with emphasis on incorporating more practical components.</li>
          <li contenteditable="true">Research initiatives were presented, with a focus on interdisciplinary projects and potential funding sources.</li>
          <li contenteditable="true">Student performance in the previous semester was analyzed, with strategies proposed for improving outcomes.</li>
        </ul>
      </div>
      ...
      <div class="event-section">
        ...
        <table>
          ...
          <tr>
            <td contenteditable="true">Finalize curriculum changes</td>
            <td contenteditable="true">Curriculum Committee</td>
            <td contenteditable="true">30th January 2025</td>
          </tr>
          <tr>
            <td contenteditable="true">Submit research proposals</td>
            <td contenteditable="true">All Faculty</td>
            <td contenteditable="true">15th February 2025</td>
          </tr>
          <tr>
            <td contenteditable="true">Prepare student feedback analysis</td>
            <td contenteditable="true">Student Affairs Committee</td>
            <td contenteditable="true">5th February 2025</td>
          </tr>
        </table>
      </div>
      
      <div class="event-section">
        <p contenteditable="true">Minutes Prepared By: [Name]</p>
        <p contenteditable="true">Approved By: Dr. Rajesh Kumar, HOD</p>
      </div>
    `,
    'blank': `
      <h1 contenteditable="true">Report Title</h1>
      <p contenteditable="true">Start typing your report here...</p>
    `
  };
  
  // Initialize
  loadTemplate('event-report');
  setupEventListeners();
  
  // Functions
  function loadTemplate(templateName) {
    reportEditor.innerHTML = templates[templateName];
    setupImageControls();
  }
  ...
  function setupEventListeners() {
      ...
      if (selection.rangeCount > 0) {
        ...
        if (selectedText) {
          ...
          if (headingLevel && headingLevel >= 1 && headingLevel <= 6) {
            const headingTag = document.createElement(`h${headingLevel}`);
            headingTag.textContent = selectedText;
            headingTag.setAttribute('contenteditable', 'true');
            
            range.deleteContents();
            range.insertNode(headingTag);
          }
        }
      }
    });
    ...
    listBtn.addEventListener('click', () => {
      const listType = confirm('Press OK for ordered list, Cancel for unordered list') ? 'ol' : 'ul';
      document.execCommand('insertUnorderedList', false, null);
      
      // Convert to the correct list type if needed
      const selection = window.getSelection();
      if (selection.rangeCount > 0) {
        const range = selection.getRangeAt(0);
        const listElement = range.commonAncestorContainer.closest('ul, ol');
    ...
    applyResizeBtn.addEventListener('click', applyImageResize);
    ...
    imageWidthInput.addEventListener('input', () => {
      if (maintainAspectRatio.checked) {
        ...
        if (!isNaN(newWidth)) {
          imageHeightInput.value = Math.round(newWidth / aspectRatio);
          updateImagePreview();
        }
      }
    });
    ...
    imageHeightInput.addEventListener('input', () => {
      if (maintainAspectRatio.checked) {
        ...
        if (!isNaN(newHeight)) {
          imageWidthInput.value = Math.round(newHeight * aspectRatio);
          updateImagePreview();
        }
      }
    });
    ...
    reportEditor.addEventListener('mouseup', updateToolbarState);
    reportEditor.addEventListener('keyup', updateToolbarState);
  }
  ...
  function handleImageUpload(event) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      reader.onload = function(e) {
        ...
        addToMediaLibrary(imageUrl, file.name);
  ...
  function addToMediaLibrary(imageUrl, imageName) {
    const mediaItem = document.createElement('div');
    mediaItem.className = 'media-item';
    mediaItem.innerHTML = `
      <img src="${imageUrl}" alt="${imageName}">
      <div class="media-actions">
        <button class="media-action-btn insert-media-btn" title="Insert into report">
    ...
    const insertBtn = mediaItem.querySelector('.insert-media-btn');
    insertBtn.addEventListener('click', () => {
      insertImageIntoReport(imageUrl, imageName);
    });
  }
  
  function insertImageIntoReport(imageUrl, imageName) {
    const selection = window.getSelection();
    const range = selection.getRangeAt(0);
  ...
  function setupImageControls() {
    // Resize buttons
    const resizeButtons = reportEditor.querySelectorAll('.resize-image-btn');
    resizeButtons.forEach(btn => {
      btn.addEventListener('click', function() {
        const imageContainer = this.closest('.image-container');
        const image = imageContainer.querySelector('img');
        openImageResizeModal(image);
      });
    });
    
    // Remove buttons
    const removeButtons = reportEditor.querySelectorAll('.remove-image-btn');
  ...
  function openImageResizeModal(image) {
    currentImage = image;
    ...
    // Set preview image
    resizeImagePreview.src = image.src;
    resizeImagePreview.style.maxWidth = '100%';
    resizeImagePreview.style.maxHeight = '180px';
    
    // Show modal
    imageResizeModal.style.display = 'block';
  }
  ...
  function updateImagePreview() {
    ...
    if (!isNaN(width) && !isNaN(height)) {
      resizeImagePreview.style.width = `${Math.min(width, 400)}px`;
      resizeImagePreview.style.height = 'auto';
    }
  }
  ...
  function insertTable() {
    ...
    for (let i = 1; i < rows; i++) {
      tableHTML += '<tr>';
      for (let j = 0; j < cols; j++) {
        tableHTML += '<td contenteditable="true">Cell ' + i + ',' + j + '</td>';
      }
      tableHTML += '</tr>';
    }
  ...
  function saveReport() {
    const reportContent = reportEditor.innerHTML;
    const reportTitle = reportEditor.querySelector('h1')?.textContent || 'Report';
  ...
  function exportToPdf() {
    alert('PDF export functionality would typically use a library like jsPDF or a server-side solution. For this demo, please use the Print function and save as PDF from your browser print dialog.');
    printReport();
  }
