document.addEventListener("DOMContentLoaded", () => {
    ...
    // Modify the showDashboard function to redirect to department dashboard when a department user logs in
    function showDashboard() {
      ...
      // For admin users, continue with the existing dashboard
